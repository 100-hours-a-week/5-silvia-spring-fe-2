...
var PaginationAnimated = function PaginationAnimated(_ref) {
  ...
  var currentPageRef = React.useRef(null);
  ...
  }, topNav || !bottomNav && !topNav ? CustomNavigation ? React.createElement(CustomNavigation, {
  ...
  })), bottomNav ? CustomNavigation ? React.createElement(CustomNavigation, {
    handlePageChange: handlePageChange,
    currentPage: currentPage,
    pages: pages,
    getContainerRef: function getContainerRef() {
...
var PaginationSwipeable = function PaginationSwipeable(_ref) {
  ...
  var CustomNavigation = customNavigation;
  var currentPageRef = React.useRef(null);
  var containerRef = React.useRef(null); // Touch
...
exports.PaginationAnimated = PaginationAnimated;
exports.PaginationSwipeable = PaginationSwipeable;
//# sourceMappingURL=react-animated-pagination.cjs.development.js.map
